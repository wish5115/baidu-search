//Strings
const CFG_SECTION = "baiduSearch";
const CFG_QUERY = "QueryTemplate";
const CMD_ID = "extension.baiduSearch";
...
function webSearch() {
  ...
  let baiduSearchCfg = vscode.workspace.getConfiguration(CFG_SECTION);
  const queryTemplate = baiduSearchCfg.get(CFG_QUERY);
